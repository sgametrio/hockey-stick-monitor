...
class LSM9DS1Class {
  public:
    ...
    virtual int readRawAcceleration(int16_t& x, int16_t& y, int16_t& z); // Results are raw.
    ...
    virtual int readRawGyroscope(int16_t& x, int16_t& y, int16_t& z); // Results are raw.
    ...
    virtual int readRawMagneticField(int16_t& x, int16_t& y, int16_t& z); // Results are raw.
